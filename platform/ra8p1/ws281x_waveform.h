...
/* HOST waveform / cost layer. SenseGlow timer/DMAC cost method adapted to
   ...
   comparison, not the product backend. Max 80 pixels for the first bench. */

#define K1_WS281X_WAVE_MAX_PIXELS 80u
#define K1_WS281X_GPT_DUTY_CAP (K1_WS281X_WAVE_MAX_PIXELS * 48u)
