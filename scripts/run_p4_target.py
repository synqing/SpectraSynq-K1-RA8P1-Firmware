...
def main():
    ...
    try:
        ...
        if info['uid']!=UID or info['build']!=build['build_id'] or info['source']!=PIN or info['cpu1_actcsr']&0x80 or not info['u55_opened']:
        ...
        if after['stack_untouched_bytes']<profile['acceptance']['stack_untouched_min_bytes'] or after['heap_total']-after['heap_maximum']<profile['acceptance']['heap_free_at_maximum_min_bytes']:
            raise RuntimeError('P4 resource reserve failed')
        receipt['pass']=True
