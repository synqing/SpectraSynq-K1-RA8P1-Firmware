...
from run_scalar_schedule import validate_stage_profile
...
class StageProfileTests(unittest.TestCase):
    def test_disposable_sources_are_instrumented_without_touching_imports(self):
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            for name in names:
                ...
                self.assertIn('K1_STAGE_BEGIN(',text)
    ...
    def test_profile_schema_and_counts_fail_closed(self):
        ...
        status={'stage_profile':{'bin_width_cycles':16384,'stages':stages}}
        validate_stage_profile(status,6000,5400)
